 ...
 * limit = int
 */
function Destro_twitter_script() {
?>
<script type="text/javascript">
<!--//--><![CDATA[//><!--
...
<script type="text/javascript" src="https://api.twitter.com/1/statuses/user_timeline/<?php echo esc_attr( of_get_option('twitter_id') ); ?>.json?callback=twitterCallback2&amp;count=2"></script>
<?php
}

if ( of_get_option('twitter_id') ) {
add_action('wp_footer', 'Destro_twitter_script', 100);
}
