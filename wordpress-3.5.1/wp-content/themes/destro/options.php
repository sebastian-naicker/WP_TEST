...
function optionsframework_options() {
	...
	$options[] = array( "name" => "country3",
		...
		$options[] = array( "name" => __("Custom Header", 'Destro' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Show custom Header?", 'Destro' ),
										"desc" => __("Selecting yes will show custom header instead of slider", 'Destro' ),
